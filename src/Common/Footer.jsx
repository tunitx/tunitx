...
export function Footer() {
  return (
    <div className="flex  flex-col   bg-gradient-to-r from-[rgb(16,51,89)]  to-color1 font-josefin">
      <footer className=" rounded-lg mb-8 lg:mb-0">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between footer mb-4">
            ...
            <VisibilitySensor partialVisibility>
              {({ isVisible }) => (
                <ul
                  className={`opacity-0 flex flex-wrap items-center lg:mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400 space-x-2 transition-all duration-500 transform ${
                    isVisible ? "animate-onLoad opacity-100" : ""
                  }`}
                >
                  <li>
                    <a
                      href="https://www.instagram.com/t_unitx/"
                      target="_blank"
                      className="   "
                    >
                      <svg
                        ...
                        height="48"
                        viewBox="0 0 48 48"
                        className=" w-[50%]  lg:w-[60%]  lg:h-[60%] transition-all duration-200 hover:animate-pulse "
                      >
                        <path
                          fill="#304ffe"
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/tanish-anand-427065228/"
                      target="_blank"
                      className="hover:underline"
                    >
                      <svg
