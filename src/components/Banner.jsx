...
export function Banner() {
  const codeBlock = `
    ...
    const CodeBlockComponent = () => {
      ...
      useEffect(() => {
        setMessage("Hi, I'm Tanish, a full stack web developer.");
      }, []);
      return (
        <div className="bg-gray-200 p-4 rounded-lg">
          <div className=" font-bold  mb-4">My Component</div>
  ...
  const codeLines = codeBlock.trim().split("\n");
  ...
  const handleMouseMove = (event) => {
    ...
    setStyle({
      transform: `perspective(500px) rotateY(${xPos * 4}deg) rotateX(${
        -yPos * 4
  ...
  return (
    <div className="flex flex-row flex-wrap lg:flex-nowrap h-[100vh] lg:h-screen w-screen justify-center mx-auto body ">
      ...
      <div className="absolute top-32 right-32 z-20 animate-pulse  ">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
      ...
      <div className="absolute bottom-28 left-42 z-20 animate-pulse  ">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
      ...
      <div className="absolute top-20 left-16 z-20 animate-pulse  ">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
      ...
      <div className="w-[14%] h-full animate-upToDown">
        <img
          src={sec_branch}
          className="absolute -top-[100px]  lg:fixed lg:top-0 w-full h-full"
          alt=""
          srcset=""
